...
, mVertexArray(0)
{
	...
	const size_t VERTEX_SIZE = 4 * sizeof(float);
	...
	glBufferData(GL_ARRAY_BUFFER, numVerts * VERTEX_SIZE, verts, GL_STATIC_DRAW);
	...
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, (GLsizei)VERTEX_SIZE, (void*)(2 * sizeof(float)));
